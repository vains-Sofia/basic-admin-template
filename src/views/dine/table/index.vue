...
import { useTable } from '@/views/dine/table/utils/hooks.tsx'
	...
	<div>
		...
		>
			...
			<el-form-item label="关键字" prop="keyword">
				<el-input v-model="form.keyword" placeholder="搜索桌台名称" clearable />
			</el-form-item>
			<el-form-item label="桌台状态" prop="tableStatus">
				<el-select v-model="form.tableStatus" placeholder="请选择状态" clearable>
					<el-option label="空闲" :value="TableStatusEnum.IDLE" />
					<el-option label="占用" :value="TableStatusEnum.OCCUPY" />
					<el-option label="留座" :value="TableStatusEnum.RESERVE_A_SEAT" />
				</el-select>
			</el-form-item>
			<el-form-item>
		...
		>
			...
			<template #operation="{ row }">
				...
				<el-popconfirm
					:title="`是否确认删除桌台名称为${row.name}的这条数据`"
